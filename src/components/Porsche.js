...
export default function Model({ ...props }) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group position={[-0.02, -0.01, 0.06]} rotation={[-Math.PI / 2, 0, 0]} scale={0.7}>
        ...
        <group position={[-1.05, 3.51, -0.13]} rotation={[-1.44, -0.62, 0.78]} scale={0.02}>
          <mesh geometry={nodes.Plane002_0.geometry} material={materials.paint} />
        </group>
        <group position={[0.44, 3.72, -0.12]} rotation={[-1.48, 0.1, 0.8]} scale={0.02}>
          <mesh geometry={nodes.Plane003_0.geometry} material={materials.paint} />
        </group>
        <group position={[-0.49, 3.68, -0.33]} rotation={[-1.42, -0.04, 0.8]} scale={0.06}>
          <mesh geometry={nodes.Plane004_0.geometry} material={materials.paint} />
        </group>
        ...
        <group position={[0.04, -1.56, 0.33]} rotation={[0.71, -0.07, -0.24]} scale={0.01}>
          <mesh geometry={nodes.Cube001_0.geometry} material={materials.plastic} />
        </group>
        ...
        <group rotation={[-0.01, 0, 0]} scale={1.04}>
          <mesh geometry={nodes.bumper_front007_0.geometry} material={materials.glass} />
        </group>
        ...
        <group position={[0.01, 3.58, 0.11]}>
          <mesh geometry={nodes.Plane001_0.geometry} material={materials.tex_shiny} />
        </group>
        ...
        <group position={[0, 3.7, -0.29]} rotation={[0.11, 0, 0]} scale={[0.39, 0.39, 0.36]}>
          <mesh geometry={nodes.Plane005_0.geometry} material={materials.license} />
        </group>
        <group position={[0, -3.75, -0.43]} rotation={[0.08, 0, Math.PI]} scale={[0.4, 0.4, 0.36]}>
          <mesh geometry={nodes.Plane006_0.geometry} material={materials.license} />
        </group>
        ...
        <group scale={[0.33, 0.32, 0.32]}>
          <mesh geometry={nodes.Cube002_0.geometry} material={materials.full_black} />
        </group>
      </group>
    </group>
  )
